...
based <- paste(diroot,"2016ff_16j/inputs/ag/",sep="")
projd <- paste(diroot,"2023ff_16j/inputs/ag/",sep="")
basef <- paste(based,"2016ff_proj_from_ag_nh3_2014NEIv2_NONPOINT_final_20180119_monthly_livestock_05oct2018_v0.csv",sep="")
projf <- paste(projd,"2023ff_proj_from_ag_nh3_2014NEIv2_NONPOINT_final_20180119_monthly_livestock_31oct2018_v0.csv",sep="")

outf <- paste(based,"2020_ag_nh3_2014NEIv2_NONPOINT_final_monthly_livestock_02Aug2019.csv",sep="")
...
inv_temp.df <- merge(x=inv_base.df,y=inv_proj.df,by=c("region_cd","scc","poll"),all=TRUE)

# Linear nterpolate between 2016 (by) and 2023 (fy) to 2020 (target)
by = 2016
fy = 2023
target = 2020
