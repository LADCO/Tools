...
based <- paste(diroot,"2016ff_16j/inputs/cmv_c3/",sep="")
projd <- paste(diroot,"2023ff_16j/inputs/cmv_c3/",sep="")
basef <- paste(based,"2016ff_proj_from_ptinv_c3_cmv_point_2014fd_ff10_18oct2018_v0.csv",sep="")
projf <- paste(projd,"2023ff_proj_from_ptinv_c3_cmv_point_2014fd_ff10_05nov2018_v0.csv",sep="")

# Set output file name, and write to base year inventory directory
outf_join <- paste(based,"2020_ptinv_c3_cmv_point_09Aug2019.csv",sep="")
outf_base <- paste(based,"base_only_2020_ptinv_c3_cmv_point_09Aug2019.csv",sep="")
outf_proj <- paste(based,"proj_only_2020_ptinv_c3_cmv_point_09Aug2019.csv",sep="")
...
inner.df$date_updated <- 20190809
